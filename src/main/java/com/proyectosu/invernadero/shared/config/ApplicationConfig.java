...
public class ApplicationConfig {
    ...
    @Bean
    public ListarInventarioUseCase listarInventarioUseCase(
            ItemInventarioRepositoryPort itemInventarioRepositoryPort
    ) {
        return new ListarInventarioUseCase(itemInventarioRepositoryPort);
    }

    @Bean
    public CrearItemInventarioUseCase crearItemInventarioUseCase(
            ItemInventarioRepositoryPort itemInventarioRepositoryPort
    ) {
        return new CrearItemInventarioUseCase(itemInventarioRepositoryPort);
    }

    @Bean
    public ActualizarItemInventarioUseCase actualizarItemInventarioUseCase(
            ItemInventarioRepositoryPort itemInventarioRepositoryPort
    ) {
        return new ActualizarItemInventarioUseCase(itemInventarioRepositoryPort);
    }

    @Bean
    public ListarPrediccionesUseCase listarPrediccionesUseCase(
            PrediccionRepositoryPort prediccionRepositoryPort
    ) {
        return new ListarPrediccionesUseCase(prediccionRepositoryPort);
    }
